...
>(({ className, sideOffset = 8, align = 'end', ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      align={align}
      className={cn(
        'z-50 min-w-[220px] rounded-xl border border-border bg-card p-1.5 shadow-pop',
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ref={ref}
    className={cn(
      'flex items-center gap-2.5 px-2.5 py-2 rounded-lg text-sm text-foreground outline-none cursor-pointer select-none transition-colors',
